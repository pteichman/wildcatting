...
var facts = []string{
	...
	`The playing out of pumped-out oil fields led to the death of any number of those once-flourishing towns. Betting fortunes on what turned out to be dusters resulted in the bankruptcies of companies and individuals.`,
